...
def send_mass_membership_notifications(group_name, membership_type, person_ids):
    """
    Send appropriate notifications to members of the group as per
    membership_type parameter
    :param group_name: name of the group
    :param membership_type: add/edit/remove
    :param person_ids: ids of the people added/edited/removed in the group
    :return: notification
    """
